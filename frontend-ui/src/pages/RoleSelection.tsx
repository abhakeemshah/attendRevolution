...
export default function RoleSelection() {
  ...
  const verifyRollNo = async () => {
    ...
    // Pass `rollNumber` in state to match frontend StudentPanel field name
    navigate("/student/scan", { state: { rollNumber } });
...
// Footer Attribution
// Developer credit displayed here for all frontend pages
// Replace/extend with a shared footer component if desired
export const FooterAttribution = () => {
  return (
    <div className="w-full text-center text-xs text-muted-foreground mt-8">
